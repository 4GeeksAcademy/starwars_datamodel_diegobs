...
class Gender(enum.Enum):
    # No se puede usar boolean con otra cosa que no sean valores lógicos true o false
    masculine = "masculine"
    # Para añadir una lista de "opciones predefinidas" es necesario usar Enum (enumeración)
    femenine = "femenine"
...
class User(db.Model):
    ...
    def serialize(self):
        ...
        # --- Relaciones --- #
    favorites: Mapped[list["Favorites"]] = relationship("Favorites", secondary="user_favorites", back_populates="user")
    # ------------------ #
...
class Favorites(db.Model):
    ...
    # --- Relaciones --- #
    user: Mapped[list["User"]] = relationship("User", secondary="user_favorites", back_populates="favorites")
    # ------------------ #
...
class Characters(db.Model):
    ...
    # --- Relaciones --- #
    homeworld: Mapped["Planets"] = relationship(
        "Planets", back_populates="residents")
    species: Mapped["Species"] = relationship(
        "Species", back_populates="residents")
    films: Mapped[list["Films"]] = relationship(
        secondary="characters_films", back_populates="characters")
    starships: Mapped[list["Starships"]] = relationship(
        secondary="characters_starships", back_populates="pilots")
    vehicles: Mapped[list["Vehicles"]] = relationship(
        secondary="characters_vehicles", back_populates="pilots")
    # ------------------ #
...
class Films(db.Model):
    ...
    characters: Mapped[list["Characters"]] = relationship(
        secondary="characters_films", back_populates="films")
    starships: Mapped[list["Starships"]] = relationship(
        secondary="starships_films", back_populates="films")
    vehicles: Mapped[list["Vehicles"]] = relationship(
        secondary="vehicles_films", back_populates="films")
...
class Planets(db.Model):
    ...
    # --- Relaciones --- #
    residents: Mapped[list["Characters"]] = relationship(
        "Characters", back_populates="homeworld")
    species: Mapped[list["Species"]] = relationship(
        "Species", back_populates="homeworld")
    # ------------------ #
...
class Species(db.Model):
    ...
    homeworld_id: Mapped[int] = mapped_column(ForeignKey("planets.id"), nullable=True)  # RELACIÓN 1 A 1

    # --- Relaciones --- #
    residents: Mapped[list["Characters"]] = relationship(
        "Characters", back_populates="species")
    homeworld: Mapped["Planets"] = relationship(
        "Planets", back_populates="species")
    # ------------------ #
...
class Starships(db.Model):
    ...
    # --- Relaciones --- #
    pilots: Mapped[list["Characters"]] = relationship(
        secondary="characters_starships", back_populates="starships")
    films: Mapped[list["Films"]] = relationship(
        secondary="starships_films", back_populates="starships")
    # ------------------ #
...
class Vehicles(db.Model):
    ...
    # --- Relaciones --- #
    pilots: Mapped[list["Characters"]] = relationship(
        secondary="characters_vehicles", back_populates="vehicles")
    films: Mapped[list["Films"]] = relationship(
        secondary="vehicles_films", back_populates="vehicles")
    # ------------------ #
